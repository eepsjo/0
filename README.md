...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `DOMAIN-SUFFIX` | `dataflow.biliapi.com` | `REJECT` | `R` | bilibili 的一个 PCDN 域名，但同時也是手機客戶端用來“緩存視頻”的域名 | ❌不处理 | 有時 bilibili 也會使用其他域名來“緩存視頻” |
...
| `DOMAIN-SUFFIX` | `mmstat.com` | `REJECT` | `r` | 阿里系域名，有明显的收集统计资料行为。拦截后可能出现：淘宝等 App 验证码无法显示；某些阿里系 App 登录异常 | 🤔待处理 | 正在测试 |